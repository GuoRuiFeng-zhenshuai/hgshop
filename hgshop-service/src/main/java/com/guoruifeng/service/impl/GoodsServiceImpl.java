...
import com.guoruifeng.dao.BrandMapper;
import com.guoruifeng.dao.CategoryDao;
import com.guoruifeng.dao.SkuDao;
import com.guoruifeng.dao.SpuDao;
...
public class GoodsServiceImpl  implements GoodsService{
	...
	public PageInfo<Brand> listBrand(String name, int page) {
		...
		return new PageInfo<Brand>(brandDao.listChar(name));
	}
